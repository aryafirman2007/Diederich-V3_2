let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  handler.command = /^(derichv2|aiderichv2)$/i;
  handler.help = ["derichv2", "aiderichv2"];
